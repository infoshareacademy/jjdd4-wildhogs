...
public class DataBaseForNow {
    ...
    public DataBaseForNow() {
        ...
        recipe1.addIngredient(new Ingredient("mayonnaise", 0.5, Unit.CUP));
        recipe1.addIngredient(new Ingredient("sour cream", 0.5, Unit.CUP));
        recipe1.addIngredient(new Ingredient("chopped cilantro", 0.25, Unit.CUP));
        recipe1.addIngredient(new Ingredient("parmesan", 1, Unit.CUP));
        recipe1.addIngredient(new Ingredient("lime", 1, Unit.UNIT));
        recipe1.addIngredient(new Ingredient("red chile powder", 1, Unit.UNIT));
        ...
        Recipe recipe2 = new Recipe("recipe2", Category.LUNCH, "Remove the husks of the corn leaving " +
                ...
                "In a small bowl mix the mayonnaise, sour cream and cilantro. Remove the corn from the grill and slather with " +
                "the mayonnaise mix. Squeeze the lime juice over the corn and heavily season with parmesan. Sprinkle with chili powder.");
        recipe2.addIngredient(new Ingredient("mayonnaise", 0.5, Unit.CUP));
        recipe2.addIngredient(new Ingredient("sour cream", 0.5, Unit.CUP));
        recipe2.addIngredient(new Ingredient("chopped cilantro", 0.25, Unit.CUP));
        recipe2.addIngredient(new Ingredient("parmesan", 1, Unit.CUP));
        recipe2.addIngredient(new Ingredient("lime", 1, Unit.UNIT));
        recipe2.addIngredient(new Ingredient("red chile powder", 1, Unit.UNIT));
        ...
        Recipe recipe3 = new Recipe("recipe3", Category.LUNCH, "Remove the husks of the corn leaving " +
                ...
                "In a small bowl mix the mayonnaise, sour cream and cilantro. Remove the corn from the grill and slather with " +
                "the mayonnaise mix. Squeeze the lime juice over the corn and heavily season with parmesan. Sprinkle with chili powder.");
        recipe3.addIngredient(new Ingredient("mayonnaise", 0.5, Unit.CUP));
        recipe3.addIngredient(new Ingredient("sour cream", 0.5, Unit.CUP));
        recipe3.addIngredient(new Ingredient("chopped cilantro", 0.25, Unit.CUP));
        recipe3.addIngredient(new Ingredient("parmesan", 1, Unit.CUP));
        recipe3.addIngredient(new Ingredient("lime", 1, Unit.UNIT));
        recipe3.addIngredient(new Ingredient("red chile powder", 1, Unit.UNIT));
        ...
        Recipe recipe4 = new Recipe("recipe4", Category.BREAKFAST, "Remove the husks of the corn leaving " +
                ...
                "In a small bowl mix the mayonnaise, sour cream and cilantro. Remove the corn from the grill and slather with " +
                "the mayonnaise mix. Squeeze the lime juice over the corn and heavily season with parmesan. Sprinkle with chili powder.");
        recipe4.addIngredient(new Ingredient("mayonnaise", 0.5, Unit.CUP));
        recipe4.addIngredient(new Ingredient("sour cream", 0.5, Unit.CUP));
        recipe4.addIngredient(new Ingredient("chopped cilantro", 0.25, Unit.CUP));
        recipe4.addIngredient(new Ingredient("parmesan", 1, Unit.CUP));
        recipe4.addIngredient(new Ingredient("lime", 1, Unit.UNIT));
        recipe4.addIngredient(new Ingredient("red chile powder", 1, Unit.UNIT));
        ...
        Recipe recipe5 = new Recipe("recipe5", Category.BREAKFAST, "Remove the husks of the corn leaving " +
                ...
                "In a small bowl mix the mayonnaise, sour cream and cilantro. Remove the corn from the grill and slather with " +
                "the mayonnaise mix. Squeeze the lime juice over the corn and heavily season with parmesan. Sprinkle with chili powder.");
        recipe5.addIngredient(new Ingredient("mayonnaise", 0.5, Unit.CUP));
        recipe5.addIngredient(new Ingredient("sour cream", 0.5, Unit.CUP));
        recipe5.addIngredient(new Ingredient("chopped cilantro", 0.25, Unit.CUP));
        recipe5.addIngredient(new Ingredient("parmesan", 1, Unit.CUP));
        recipe5.addIngredient(new Ingredient("lime", 1, Unit.UNIT));
        recipe5.addIngredient(new Ingredient("red chile powder", 1, Unit.UNIT));
        ...
        Recipe recipe6 = new Recipe("recipe6", Category.BREAKFAST, "Remove the husks of the corn leaving " +
                ...
                "In a small bowl mix the mayonnaise, sour cream and cilantro. Remove the corn from the grill and slather with " +
                "the mayonnaise mix. Squeeze the lime juice over the corn and heavily season with parmesan. Sprinkle with chili powder.");
        recipe6.addIngredient(new Ingredient("mayonnaise", 0.5, Unit.CUP));
        recipe6.addIngredient(new Ingredient("sour cream", 0.5, Unit.CUP));
        recipe6.addIngredient(new Ingredient("chopped cilantro", 0.25, Unit.CUP));
        recipe6.addIngredient(new Ingredient("parmesan", 1, Unit.CUP));
        recipe6.addIngredient(new Ingredient("lime", 1, Unit.UNIT));
        recipe6.addIngredient(new Ingredient("red chile powder", 1, Unit.UNIT));
